...
$0 nimbus.sepolia 'sudo systemctl --no-block start update-beacon-node-sepolia-stable'

echo linux-01.ih-eu-mda1.nimbus.sepolia | $0 'sudo systemctl --no-block start update-beacon-node-sepolia-stable'
"
}
